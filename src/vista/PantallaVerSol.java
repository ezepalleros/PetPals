...
public class PantallaVerSol extends JFrame {
	...
	private void actualizarTabla() {
		...
		for (Solicitud solicitud : solicitudes) {
			model.addRow(new Object[] { solicitud.getCodSol(), solicitud.getCodSer(), solicitud.getDiaSer(),
					solicitud.getHoraIniSer(), solicitud.getHoraFinSer(), solicitud.getCodMas(), solicitud.getTipoMas(),
