...
public class PantallaGesSer extends JFrame {
    ...
    public PantallaGesSer(LocalDate diaActual) {
        this.diaActual = diaActual; // Asignamos la fecha actual recibida
    ...
    private void actualizarTabla() {
        ...
        for (Servicio servicio : servicios) {
            model.addRow(new Object[]{
                ...
                servicio.getPrecioPerro(),
                servicio.getPrecioGato(),
                servicio.getPrecioAve(),
                servicio.getPrecioRoedor(),
                servicio.getPrecioReptil()
            });
        }
    }
