    ...
    public PantallaAgrMas(int codCli) {
        ...
        btnGuardar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (!error) {
                    // Crear una nueva mascota y guardarla
                    Mascota nuevaMascota = new Mascota(0, nomMas, variMas, tipoMas, Integer.parseInt(txtEdadMas.getText()),
                            vacuMas, caracMas, dietMas, chipMas, 0, codCli);
