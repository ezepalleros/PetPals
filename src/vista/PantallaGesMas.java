...
public class PantallaGesMas extends JFrame {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        seleccionado = new Mascota(id, nombre, variedad, tipo, edad, vacunado, caracteristicas, dieta, chip, adoptar, duenio);
    ...
    private void actualizarTabla() {
        ...
        for (Mascota mascota : mascotas) {
            model.addRow(new Object[] { mascota.getCodMas(), mascota.getNomMas(), mascota.getVariMas(), mascota.getTipoMas(), mascota.getEdadMas(), mascota.getVacuMas(), mascota.getCaracMas(), mascota.getDietMas(), mascota.getChipMas(), mascota.getAdoptar(), mascota.getDueMas() });
        }
    }
